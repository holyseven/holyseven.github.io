...
![Figure 5](/assets/images/dataset-diversity-sft/x5.png)
...
![Figure 6](/assets/images/dataset-diversity-sft/x6.png)
*Figure 6: (a) 控制 response 长度在 ~500 token 后，多样性-性能关系不变；(b) 用 word-based 分词替代 LLM tokenizer 后，正相关消失。*

将所有数据集的 response 长度控制在约 500 token，多样性与性能的正相关不变。这排除了"多样性高的数据集只是 response 更长"这个混淆因素。
